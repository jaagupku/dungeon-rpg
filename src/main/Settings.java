...
public class Settings {
	...
	private static final Settings DEFAULT = new Settings(false, "4:3", 1280, 720, 1.0, 1.0, 1.0);
	...
	public static ObservableList<String> getResolutionLabels(String ratio) {
		switch (ratio) {
		case "4:3":
			return FXCollections.observableArrayList("640x480", "800x600", "1024x768", "1152x864", "1280x960", "1400x1050", "1600x1200");
		case "16:9":
